...
class FormulariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulario" do
    assert_difference('Formulario.count') do
      post formularios_url, params: { formulario: { correo: @formulario.correo, nombre: @formulario.nombre, telefono: @formulario.telefono } }
    end
  ...
  test "should update formulario" do
    patch formulario_url(@formulario), params: { formulario: { correo: @formulario.correo, nombre: @formulario.nombre, telefono: @formulario.telefono } }
